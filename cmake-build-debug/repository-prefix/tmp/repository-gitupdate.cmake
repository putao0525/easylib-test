...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/putao/code/test/c/esaylib-test/cmake-build-debug/repository-prefix/src/repository'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/putao/code/test/c/esaylib-test/cmake-build-debug/repository-prefix/src/repository'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
